...
// import { PopUpAjouterEtudiantComponent } from './pop-up-<ajouter>-etudiant/pop-up-ajouter-etudiant.component';
...
export class ProfesseurEtudiantsComponent implements OnInit {
  ...
  openAjouterEtudiantDialog(): void {
    // const dialogRef = this.matDialog.open(PopUpAjouterEtudiantComponent, {
    //   width: '400px',
    // });
